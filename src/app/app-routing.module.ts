...
import { CanActivateGuard } from "app/questions/can-activate.guard";
...
const appRoutes: Routes = [
  { path: '', component: LoginComponent, pathMatch: 'full' },
  {
    ...
    children: [
      { path: '', component: QuestionsComponent, canDeactivate: [CanDeactivateGuard],canActivate:[CanActivateGuard] },
